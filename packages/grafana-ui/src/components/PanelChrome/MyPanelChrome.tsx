 ...
 * @internal
 */
export type MyPanelChromeProps = (AutoSize | FixedDimensions) & (Collapsible | HoverHeader);

interface BaseProps {
  padding?: MyPanelPadding;
  title?: string;
 ...
 * @internal
 */
export type MyPanelPadding = 'none' | 'md';

/**
 * @internal
 */
export function MyPanelChrome({
  width,
  height,
  children,
  padding = 'md',
